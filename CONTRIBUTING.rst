...
Scholia development is hosted at https://github.com/ad-freiburg/scholia.
...
1. Clone Scholia repository from GitHub
   ...
   .. code:: shell
       ...
       $ git clone https://github.com/ad-freiburg/scholia.git     # via HTTPS
       $ git clone git@github.com:ad-freiburg/scholia.git         # or via SSH
...
2. Write a new query and add it in a template file (e.g. in  ``/app/templates/sparql/author_awards.sparql``)
   ...
   See example at https://github.com/ad-freiburg/scholia/pull/848/files.
...
5. Add the whole thing to your version/fork of the file
   https://github.com/ad-freiburg/scholia/tree/main/scholia/[…].
